...
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" src="<%= request.getContextPath() %>/assets/images/image1.png" style="width:200px">
					<h2>안녕하세요. 하진수의  mysite에 오신 것을 환영합니다.</h2>
					<p>
		...
		<div id="navigation">
			<ul>
				<li><a href="<%= request.getContextPath() %>">하진수</a></li>
